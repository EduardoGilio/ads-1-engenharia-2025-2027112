...
As principais caracteristicas deste modelo são:
- Sequência de fases, onde tem que concluir para poder ir para a proxima fase de desenvolvimento.
- Planejamento e flexibilidade em relação as fases do projeto.
